  ...
  return (
    <>
      <div className="text-white flex flex-col items-center space-y-8">
        <h2 className="text-3xl font-bold mt-10">Privacy Policy</h2>
        <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-start gap-10 gap-x-2 text-white">
          <p className="pb-20">
            ...
            <br /> By using the Service, You agree to the collection and use of
            ...
            <br />
            <br />
            Definitions For the purposes of this Privacy Policy: You means the
            ...
            “Our” in this Agreement) refers to LearnSwift.com. <br />
            <br />
            ...
            <br />
            <br /> Website refers to LearnSwift.com, accessible
            fromLearnSwift.com Service refers to the Website.
            <br /> Country refers to: Chhattishgarh, India Service Provider
            ...
            <br /> Third-party Social Media Service refers to any website or any
            social network website through which a User can log in or create an
            account to use the Service.
            <br /> Personal Data is any information that relates to an
            identified or identifiable individual.
            <br />
            Cookies are small files that are placed on Your computer, mobile
            device or any other device by a website, containing the details of
            Your browsing history on that website among its many uses. Usage
            ...
            name Phone number Usage Data Usage Data Usage Data is collected
            ...
            mobile device. Tracking Technologies and Cookies We use Cookies and
            ...
            You may not be able to use some parts of our Service. Cookies can be
            ...
            below: Necessary / Essential CookiesType: Session
            CookiesAdministered by: UsPurpose: These Cookies are essential to
            ...
            Cookies Policy / Notice Acceptance CookiesType: Persistent
            CookiesAdministered by: UsPurpose: These Cookies identify if users
            have accepted the use of cookies on the Website. Functionality
            ...
            following purposes: To provide and maintain our Service, including
            to monitor the usage of our Service. To manage Your Account: to
            ...
            manage Your requests to Us. We may share your personal information
            in the following situations: With Service Providers: We may share
            ...
            help support and maintain Our Service, to contact You, to advertise
            on third party websites to You after You visited our Service or for
            payment processing. For Business transfers: We may share or transfer
            ...
            to offer You certain products, services or promotions. With other
            ...
            see You name, profile, pictures and description of Your activity.
            ...
            Your Personal Data The Company will retain Your Personal Data only
            ...
            obligated to retain this data for longer time periods. Transfer of
            Your Personal Data Your information, including Personal Data, is
            ...
            data and other personal information. Disclosure of Your Personal
            Data Business Transactions If the Company is involved in a merger,
            ...
            becomes subject to a different Privacy Policy. Law enforcement Under
            ...
            agency). Other legal requirements The Company may disclose Your
            Personal Data in the good faith belief that such action is necessary
            to: Comply with a legal obligation Protect and defend the rights or
            property of the Company Prevent or investigate possible wrongdoing
            in connection with the Service Protect the personal safety of Users
            ...
            information from Our servers. We also may limit how We collect, use,
            and store some of the information of Users between 13 and 18 years
            old. In some cases, this means We will be unable to provide certain
            functionality of the Service to these users. If We need to rely on
            ...
            Websites Our Service may contain links to other websites that are
